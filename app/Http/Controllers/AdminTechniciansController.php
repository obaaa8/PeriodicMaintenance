<?php namespace App\Http\Controllers;
	...
	class AdminTechniciansController extends \crocodicstudio\crudbooster\controllers\CBController {
      ...
      # START COLUMNS DO NOT REMOVE THIS LINE
			...
			# END FORM DO NOT REMOVE THIS LINE# END FORM DO NOT REMOVE THIS LINE
			...
			//$this->form[] = ["label"=>"Identity Type","name"=>"identity_type","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Identity No","name"=>"identity_no","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Phonenumber","name"=>"phonenumber","type"=>"number","required"=>TRUE,"validation"=>"required|numeric","placeholder"=>"You can only enter the number only"];
			# OLD END FORM
